...
struct CFutureFtdcInvestorProductGroupMarginField
{
	...
	TFutureFtdcHedgeFlagType	HedgeFlag;
	///昨日多头冻结的保证金
	TFutureFtdcMoneyType	YDLongFrozenMargin;
	///昨日空头冻结的保证金
	TFutureFtdcMoneyType	YDShortFrozenMargin;
	///昨日多头保证金
	TFutureFtdcMoneyType	YDLongUseMargin;
	///昨日空头保证金
	TFutureFtdcMoneyType	YDShortUseMargin;
	///昨日交易所多头保证金
	TFutureFtdcMoneyType	YDLongExchMargin;
	///昨日交易所空头保证金
	TFutureFtdcMoneyType	YDShortExchMargin;
	///昨日多头折抵总金额
	TFutureFtdcMoneyType	YDLongOffsetAmount;
	///昨日空头折抵总金额
	TFutureFtdcMoneyType	YDShortOffsetAmount;
	///昨日交易所多头折抵总金额
	TFutureFtdcMoneyType	YDLongExchOffsetAmount;
	///昨日交易所空头折抵总金额
	TFutureFtdcMoneyType	YDShortExchOffsetAmount;
};
