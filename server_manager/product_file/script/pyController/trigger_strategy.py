...
class TestThriftServer:
    ...
    def Ping(self):
        try:
            ...
            log.info('Ping(), return:{0}'.format(ret_error))
    ...
    def QryThread(self):
        while 1:
            try:
                ...
                log.info('QryDefaultParams(), return:{0}'.format(ret_QryParams.count))
...
class Feed:
    ...
    def Init(self, sett):
        try:
            ...
            log.info('Init(), return:{0}'.format(ret_error))
        except Thrift.TException as tx:
    ...
    def ChangeStratStatus(self, stratID, status):
        try:
            ...
            log.info('ChangeStratStatus(), return:{0}'.format(ret_error))
        except Thrift.TException as tx:
    ...
    def PullFeeds(self):
        while 1:
            try:
                ...
                log.info('PullFeeds(), return:{0}'.format(rtn_feeds.count))
    ...
    def PullMsg(self):
        try:
            ...
            if ret_QryParams.count != 0:
                log.info('PullMsg(), return:{0}'.format(ret_QryParams.count))
            for i in ret_QryParams.notifications:
                log.info("%s, %s, %s", i.stratID, i.msgType, i.msg)
    ...
    def PullOrders(self):
        ...
        try:
            ...
            if rtn_orders.count != 0:
                log.info('PullOrders(), return:{0}'.format(rtn_orders.count))
    ...
    def PullTrades(self):
        ...
        try:
            ...
            if rtn_trades.count != 0:
                log.info('PullTrades(), return:{0}'.format(rtn_trades.count))
